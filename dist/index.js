    ...
    _createClass(SVGWrapper, [
        ...
        },
        {
            ...
            value: function computeSubTrees(rootNode) {
                ...
                validAttributeNames.forEach(function (eachAttributeName, inx) {
                    var eachAttributeNameExists =
                        attributeNameMapping[
                            attributes[eachAttributeName].nodeName
                        ];
                ...
                rootNode.childNodes.forEach(function (eachChild) {
                    ...
                    var nodeValue =
                        eachChild === null || eachChild === void 0
                            ? void 0
                            : (_eachChild$nodeValue = eachChild.nodeValue) ===
                                  null || _eachChild$nodeValue === void 0
                            ? void 0
                ...
                if (actualChildNodes.length === 0) {
                    ...
                    actualChildNodes.forEach(function (eachChild, inx) {
                        var currentChildNode = _objectSpread(
                            {},
                            _this3.computeSubTrees(eachChild)
                        );

                        actualChildNodes[inx] = _objectSpread(
                            {},
                            currentChildNode
                        );
                    });
        ...
        },
        {
            ...
            value: function performConversion() {
                ...
                for (
                    var inx = 0;
                    inx < wrapperCompObject.childNodes.length;
                    inx++
                ) {
                    if (
                        wrapperCompObject.childNodes[inx].nodeName !==
                        "#comment"
                    ) {
                        rootNodeIndex = inx;
                        break;
                ...
                var rootObject = this.computeSubTrees(
                ...
                if (type === "file") {
                    fetch(src)
                        ...
                        .then(function (resText) {
                            var updatedCompWrapperObject = _objectSpread(
                                {},
